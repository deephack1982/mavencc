...
User.create!(user: 6666, pass: 'pepper1899', full_name: 'Administrator', user_level: 9, user_group: 'Admin', active: 'Y', password: 'pepper1899', password_confirmation: 'pepper1899')
Campaign.create!(campaign_id: 'Test', campaign_name: 'Test Campaign', campaign_description: 'Test Campaign', active: 'N', lead_order: 'DOWN', hopper_level: '1', dial_method: 'MANUAL', auto_dial_level: 1, adaptive_intensity: 0, user_group: '1', dial_statuses: ' NEW ')
